  ...
  for (const tenant of allTenants) {
    ...
    await runWithTenant(tenant.id, async () => {
      ...
      const salaryComponents = [
        ...
        { name: 'Education Allowance', code: 'EDUCATION_ALLOWANCE', type: 'EARNING', calculationType: 'FLAT', value: 0, isEPFApplicable: true, isESIApplicable: true },
        { name: 'Medical Allowance', code: 'MEDICAL_ALLOWANCE', type: 'EARNING', calculationType: 'FLAT', value: 0, isEPFApplicable: true, isESIApplicable: true },
        { name: 'L.T.A', code: 'LTA', type: 'EARNING', calculationType: 'FLAT', value: 0, isEPFApplicable: true, isESIApplicable: true },
        { name: 'Special Allowance', code: 'SPECIAL_ALLOWANCE', type: 'EARNING', calculationType: 'FLAT', value: 0, isEPFApplicable: false, isESIApplicable: false },
