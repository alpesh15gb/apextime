        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-400 text-[10px] font-black uppercase tracking-widest mt-1 italic">Managing hardware interfaces and data ingestion protocols</p>
                </div>
                <button
                    ...
                    devices.map((device) => (
                        <div key={device.id} className="app-card group relative p-8 space-y-6 hover:translate-y-[-4px] transition-all overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <h3 className="text-xl font-black text-gray-900 tracking-tighter">{device.name}</h3>
                            ...
                            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-50 relative z-10">
                                <div className="space-y-1">
                                    <p className="text-[9px] font-black text-gray-400 uppercase tracking-tighter">Protocol</p>
                                    <p className="text-xs font-bold text-gray-700">{device.protocol}</p>
                                </div>
                                <div className="space-y-1">
                                    <p className="text-[9px] font-black text-gray-400 uppercase tracking-tighter">Identifier</p>
                            ...
                            <div className="flex items-center justify-between pt-4 relative z-10">
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-[9px] font-black text-gray-500 uppercase">Live Stream</span>
                                </div>
                                <div className="px-3 py-1 bg-gray-100 rounded-lg text-[9px] font-black text-gray-500 italic">
                    ...
                    <div className="bg-white rounded-[40px] shadow-2xl w-full max-w-xl overflow-hidden border border-white/20 animate-in zoom-in-95 duration-200">
                        <div className="p-10 border-b border-gray-50 bg-gray-50/30">
                            <div className="flex items-center gap-4 mb-2">
                                ...
                                <h3 className="text-2xl font-black tracking-tight text-gray-900">{editingDevice ? 'Recalibrate Node' : 'Initialize Hardware Node'}</h3>
                            </div>
                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest italic ml-14">Configure ingestion parameters for biometric interface</p>
                        </div>

                        <form onSubmit={handleSubmit} className="p-10 space-y-6">
                            <div className="grid grid-cols-2 gap-6">
                                <div className="col-span-2">
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 block">Friendly Node Name</label>
                                    <input
                                        type="text"
                                        required
                                        value={formData.name}
                                ...
                                <div>
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 block">Protocol Matrix</label>
                                    <select
                                ...
                                <div>
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 block">Sector / Location</label>
                                    <input
                                        type="text"
                                ...
                                {['ESSL_ADMS', 'MATRIX_DIRECT', 'REALTIME_DIRECT', 'HIKVISION_DIRECT'].includes(formData.protocol) ? (
                                    <div className="col-span-2">
                                        ...
                                        />
                                        <p className="text-[9px] font-bold text-blue-400 mt-2 italic px-1">Node will push to: http://vps-url/api/iclock using this SN</p>
                                    </div>
                                ) : (
                                    <>
                                        <div>
                                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 block">IP Address / Host</label>
                                            <input
                                                type="text"
                                        ...
                                        <div>
                                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 block">Communication Port</label>
                                            <input
                                                type="number"
                                                value={formData.port}
