...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FAFAFA] relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-gray-100 rounded-full blur-[120px] opacity-60"></div>

      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-0 bg-white rounded-[48px] shadow-2xl shadow-gray-200/50 overflow-hidden relative z-10 mx-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="pt-4">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-6 bg-red-600 text-white font-black text-xs uppercase tracking-widest rounded-[24px] hover:bg-red-700 shadow-2xl shadow-red-200 transition-all flex items-center justify-center space-x-3 disabled:bg-gray-100 disabled:text-gray-300 disabled:shadow-none translate-y-0 active:translate-y-1"
              >
                {isLoading ? (
