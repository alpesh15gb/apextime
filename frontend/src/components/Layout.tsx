      ...
      : user?.role === 'superadmin'
        ...
        : user?.tenantType === 'SCHOOL'
          ...
          : [
            ...
            { path: '/payroll/location', icon: Building, label: 'Location Payroll', module: 'payroll' },
            { path: '/payroll/adjustments', icon: Receipt, label: 'Adjustments', module: 'payroll' },
            { path: '/payroll/form16', icon: FileText, label: 'Form 16', module: 'payroll' },
